      ...
      <div className=" h-72 flex justify-center items-center bg-grayy">
        <div className="grid grid-cols-4 h-[80%] ">
          <div className=" pl-5 w-[70%] ">
            <h2 className="text-bgreen text-2xl font-bold mb-1">E-Book.</h2>
          ...
          <div className="  w-[70%] -ml-8">
            ...
            <ul className=" flex flex-col space-y-1  ">
              <Link
                ...
                className="text-pgray  font-semibold  w-fit "
              >
                Home
              </Link>
              <NavLink
              ...
              <NavLink to="/blog" className="text-pgray  font-semibold w-fit">
                Blog
              </NavLink>
            </ul>
          </div>
          ...
          <div className=" -ml-32  ">
            ...
            <div className="my-2">
              <input
                ...
                className="w-[85%] h-9 pl-2 pb-[2px] rounded-2xl shadow-lg outline-none text-pgray font-semibold placeholder:font-medium"
              />
              <button className="-ml-[90px] rounded-2xl bg-bgreen text-white text-sm font-semibold px-2 h-8 shadow-xl ">
                Subscribe
              </button>
            </div>
          </div>
